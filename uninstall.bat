...
rem     curl -fsSL https://raw.githubusercontent.com/kill136/axon/private_web_ui/uninstall.bat -o uninstall.bat && uninstall.bat
rem   Or one-liner from cmd (Gitee, for China):
rem     curl -fsSL https://gitee.com/lubanbbs/axon/raw/private_web_ui/uninstall.bat -o uninstall.bat && uninstall.bat
rem ============================================
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "try { Invoke-WebRequest -Uri 'https://github.com' -UseBasicParsing -TimeoutSec 5 -ErrorAction Stop | Out-Null; $url = 'https://raw.githubusercontent.com/kill136/axon/private_web_ui/uninstall.ps1' } catch { $url = 'https://gitee.com/lubanbbs/axon/raw/private_web_ui/uninstall.ps1' }; " ^
