...
## When to Write
- User shares personal info (name, role, preferences) → experience
- You discover something about the project not in CLAUDE.md → project
- User explicitly asks you to remember something → experience or project
