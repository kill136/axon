...
- New feature with architectural decisions needed
...
- Pure research/exploration (use Task with Explore agent)

In plan mode you'll:
1. Explore the codebase (read-only) using Glob, Grep, and Read
2. Write your implementation plan to PLAN.md
3. Exit with ExitPlanMode for user approval
4. Implement after approval

This tool REQUIRES user approval to enter plan mode.`;
...
- Only for implementation planning tasks, NOT for pure research/exploration
- If requirements are ambiguous, use AskUserQuestion to clarify BEFORE calling this tool`;
