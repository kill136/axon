...
- [五、核心功能详解](#五核心功能详解)
  ...
  - [5.6 斜杠命令](#56-斜杠命令)
- [六、进阶用法](#六进阶用法)
  - [6.1 AXON.md 项目规则](#61-axonmd-项目规则)
...
Axon 是一个**开源的 AI 编程平台**，它把 Claude AI 变成一个能直接操作你电脑的编程助手——不只是聊天，它能：
...
在项目根目录创建 `AXON.md` 文件，写入你的项目规则和约束。AI 每次启动都会自动读取这个文件。
...
> **关键理解**：每次新对话，AI 都是全新实例（没有记忆）。AXON.md 是唯一跨对话持久生效的"规则约束"。
...
在 `.axon/skills/my-skill/SKILL.md` 创建文件：
